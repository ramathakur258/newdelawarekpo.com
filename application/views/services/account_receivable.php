    ...
    <div class="page-header">
        <div class="page-header-wrapper" style="background-image: url('<?php echo base_url('assets/images1/bk-1.jpg');?>');">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="page-header-content">
                            <h1 class="c-white"><?php echo $service->service; ?> </h1>
                            <p class="small ln-ht-auto c-white">Got questions? <a href="<?php echo base_url('contact');?>" class="link link-inherit"><span>Talk to an Expert</span></a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="service-detail">
        <div class="service-detail-wrapper">
                ...
                <div class="row d-lg-flex align-items-lg-center">
                    <div class="col-lg-7 order-2 order-lg-1">
                        <div class="service-detail-content">
                            <h2 class="ln-ht-44"><?php echo $service->service; ?> </h2>
                            <p class="large c-grey"><?php echo $service->description; ?></p>
                    ...
                    <div class="col-lg-5 d-inline-flex justify-content-lg-end justify-content-center order-lg-2 order-1">
                        <div class="service-detail-icon">
                            <div class="icon-circle icon-circle-xl">
                                <img src="<?php echo base_url('assets/images1/account-receivable.jpg');?>" alt="icon">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="image intro-bg">
                <img src="<?php echo base_url('assets/images1/service-detail-img.jpg');?>" alt="image">
            </div>
        </div>
    </div>
    <!----------------------------------------
