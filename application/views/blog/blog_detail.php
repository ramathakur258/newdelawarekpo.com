    ...
    <div class="sidebar-page page-bg">
        <div class="sidebar-page-wrapper page-bg-wrapper padd-150">
                            ...
                            <div class="blog-list-wrapper">
                                <div class="blog-single">
                                    <div class="post">
										...
										<div class="entry-meta regular greylinks">
											<span class="entry-date">
												<time class="entry-date" datetime="2017-03-13T08:50:40+00:00">
													 <?php echo date("d M, Y",strtotime($blogdetail->created_at)); ?>
												</time>
											</span>
											<span>
                                        ...
                                        <a class="title mb-3" href="blog-detail.html"><?php echo $blogdetail->blog_title;  ?></a>
                                        <p class="f-16"><?php echo $blogdetail->description;  ?></p>
